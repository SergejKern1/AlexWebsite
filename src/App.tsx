...
import GameArt from './components/pages/GameArt';
  import IntoTheCold from './components/pages/GameArt/IntoTheCold';
  import Pitrush from './components/pages/GameArt/Pitrush';
  import Okjo from './components/pages/GameArt/Okjo';
